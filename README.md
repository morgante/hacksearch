...
~~~sh
# getting the code
git clone git@github.com:nko4/tigercat.git && cd ./tigercat/

# developing
npm install
npm start

# deploying (to http://tigercat.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@tigercat.2013.nodeknockout.com
ssh root@tigercat.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@tigercat.2013.nodeknockout.com
ssh -i ./id_deploy root@tigercat.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/tigercat" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
